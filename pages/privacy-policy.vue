...
<template>
  ...
  >
    ...
    <p>
      ...
      protection is of a particularly high priority for the website's
      maintainer. The use of the Internet pages of the website's maintainer, is
    ...
    <p>
      ...
      website's maintainer. By means of this data protection declaration, our
    ...
    <p>
      As the controller, we implemented numerous technical and organizational
    ...
    <h4>1. Definitions</h4>
    <p>
      The data protection declaration of the website's maintainer is based on
    ...
    <h4>3. Cookies</h4>
    <p>
      The Internet pages of the website's maintainer use cookies. Cookies are
    ...
    <p>
      Through the use of cookies, the website's maintainer can provide the users
    ...
    <p>
      The website of the website's maintainer collects a series of general data
    ...
    <p>
      When using these general data and information, the website's maintainer
      ...
      Therefore, the website's maintainer analyzes anonymously collected data
    ...
    <ul class="list-none">
      ...
      <li>
        ...
        <p>
          ...
          wishes to request the erasure of personal data stored by this website
          or services used by this website, he or she may, at any time, contact
          the controller. The website's maintainer shall promptly ensure that
        ...
        <p>
          ...
          required. The website's maintainer will arrange the necessary measures
          in individual cases.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          stored by this website or services used by this website, he or she may
          at any time contact the controller. The website's maintainer will
      ...
      <li>
        ...
        <p>
          ...
          at any time contact the website's maintainer.
        </p>
      </li>
      <li>
        ...
        <p>
          The website's maintainer shall no longer process the personal data in
        ...
        <p>
          ...
          to such direct marketing. If the data subject objects to the website's
          maintainer to the processing for direct marketing purposes, the
          website's maintainer will no longer process the personal data for
          these purposes.
        </p>
        ...
        <p>
          ...
          data concerning him or her by the website's maintainer for scientific
          or historical research purposes, or for statistical purposes pursuant
        ...
        <p>
          ...
          any employee of the website's maintainer. In addition, the data
      ...
      <li>
        ...
        <p>
          ...
          it is based on the data subject's explicit consent, the website's
          maintainer shall implement suitable measures to safeguard the data
        ...
        <p>
          ...
          individual decision-making, he or she may, at any time, contact the
          website's maintainer.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          consent, he or she may, at any time, contact the website's maintainer.
        </p>
      </li>
    </ul>
    <h4>
      7. Data protection provisions about the application and use of functions
      pertaining to the collection society WORT (VG WORT)
    </h4>
    <p>
      ...
      enable a log file recording and a log file analysis so that a statistical
      analysis may be performed. The integrated tracking pixels serve the
      Scalable Central Measurement System (SZMS) of the collecting society WORT
      (VG Wort).
    </p>
    ...
    <p>
      ...
      collected anonymously. To capture the traffic, either a so-called session
      cookie is created for the purpose of recognition of the users of a
      website, that is a signature, which consists of various automatically
    ...
    <p>
      ...
      the web browser used and thus contradict the setting of cookies
      permanently. Such an adjustment to the Internet browser used would also
      prevent VG Wort from setting a cookie on the information technology system
      of the data subject. In addition, cookies already in use by VG Wort may be
    ...
    <p>
      ...
      sets an opt-out cookie. The opt-out cookie used for this purpose is placed
    ...
    <p>
      The operating company of YouTube is Google Ireland Limited, Gordon House,
    ...
    <p>
      ...
      <a href="https://www.wbs-law.de/eng/">German Lawyers</a> from WILDE BEUGER
      SOLMECKE, Cologne.
    </p>
  </article>
</template>
